 ...
 * @param  {AcquireTokenCallback} callback
 */
TokenRequest.prototype._getTokenUsernamePasswordManaged = function(username, password, clientSecret, callback) {
    ...
    this._userRealm.discover(function(err) {
      ...
      switch(self._userRealm.accountType) {
        case AccountType.Managed:
          self._getTokenUsernamePasswordManaged(username, password, clientSecret, getTokenCompleteCallback);
          return;
